    ...
    <div className="gateway-container">
      ...
      <div className="gateway-header">
        ...
        <div className="gateway-title-section">
          <div className="gateway-title-icon">
      ...
      <div className="card-modal">
        <header className="card-modal-header">
          <div className="card-modal-title">
            ...
            <div>
              ...
              <p className="card-modal-subtitle">Completá los datos de tu tarjeta de {form.kind === 'credit' ? 'crédito' : 'débito'}</p>
            </div>
          </div>
          <button 
        ...
        <footer className="card-modal-footer">
          <div className="card-modal-actions">
            <button className="card-btn card-btn--secondary" onClick={onClose}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18 6L6 18M6 6L18 18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              Cancelar
